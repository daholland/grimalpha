...
// extern "C" {
//     fn ISteamAppList_GetNumInstalledApps() -> u32;
//     fn ISteamAppList_GetInstalledApps(AppId_t *pvecAppID, u32 unMaxAppIDs) -> u32;
//     fn ISteamAppList_GetAppName(AppId_t nAppID, char *pchName, c_int cchNameMax) -> c_int;
//     fn ISteamAppList_GetAppInstallDir(AppId_t nAppID, char *pchDirectory, c_int cchNameMax) -> c_int;
//     fn ISteamAppList_GetAppBuildId(AppId_t nAppID) -> c_int;
...
//     fn ISteamApps_GetEarliestPurchaseUnixTime(AppId_t nAppID) -> u32;
//     fn ISteamApps_BIsSubscribedFromFreeWeekend() -> bool;
//     fn ISteamApps_GetDLCCount() -> c_int;
//     fn ISteamApps_BGetDLCDataByIndex(c_int iDLC, AppId_t *pAppID, bool *pbAvailable, char *pchName, c_int cchNameBufferSize) -> bool;
...
//     fn ISteamApps_GetCurrentBetaName(char *pchName, c_int cchNameBufferSize) -> bool;
//     fn ISteamApps_MarkContentCorrupt(bool bMissingFilesOnly) -> bool;
//     fn ISteamApps_GetInstalledDepots(AppId_t appID, DepotId_t *pvecDepots, u32 cMaxDepots) -> u32;
//     fn ISteamApps_GetAppInstallDir(AppId_t appID, char *pchFolder, u32 cchFolderBufferSize) -> u32;
...
//     fn ISteamApps_GetDlcDownloadProgress(AppId_t nAppID, uc_int64 *punBytesDownloaded, uc_int64 *punBytesTotal) -> bool;
//     fn ISteamApps_GetAppBuildId() -> c_int;
...
//     fn ISteamClient_SetLocalIPBinding(u32 unIP, u16 usPort) -> void;
...
//     fn ISteamClient_GetIPCCallCount() -> u32;
...
//     fn ISteamController_GetConnectedControllers(ControllerHandle_t *handlesOut) -> c_int;
...
//     fn ISteamController_GetDigitalActionOrigins(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetHandle, ControllerDigitalActionHandle_t digitalActionHandle, EControllerActionOrigin *originsOut) -> c_int;
...
//     fn ISteamController_GetAnalogActionOrigins(ControllerHandle_t controllerHandle, ControllerActionSetHandle_t actionSetHandle, ControllerAnalogActionHandle_t analogActionHandle, EControllerActionOrigin *originsOut) -> c_int;
...
//     fn ISteamFriends_GetFriendCount(c_int iFriendFlags) -> c_int;
//     fn ID_t ISteamFriends_GetFriendByIndex(c_int iFriend, c_int iFriendFlags) -> Stea;
...
//     fn ISteamFriends_GetFriendPersonaNameHistory(CSteamID steamIDFriend, c_int iPersonaName) -> const char *;
//     fn ISteamFriends_GetFriendSteamLevel(CSteamID steamIDFriend) -> c_int;
//     fn ISteamFriends_GetPlayerNickname(CSteamID steamIDPlayer) -> const char *;
//     fn ISteamFriends_GetFriendsGroupCount() -> c_int;
//     fn ID_t ISteamFriends_GetFriendsGroupIDByIndex(c_int iFG) -> FriendsGrou;
//     fn ISteamFriends_GetFriendsGroupName(FriendsGroupID_t friendsGroupID) -> const char *;
//     fn ISteamFriends_GetFriendsGroupMembersCount(FriendsGroupID_t friendsGroupID) -> c_int;
//     fn ISteamFriends_GetFriendsGroupMembersList(FriendsGroupID_t friendsGroupID, CSteamID *pOutSteamIDMembers, c_int nMembersCount) -> void;
//     fn ISteamFriends_HasFriend(CSteamID steamIDFriend, c_int iFriendFlags) -> bool;
//     fn ISteamFriends_GetClanCount() -> c_int;
//     fn ID_t ISteamFriends_GetClanByIndex(c_int iClan) -> Stea;
//     fn ISteamFriends_GetClanName(CSteamID steamIDClan) -> const char *;
//     fn ISteamFriends_GetClanTag(CSteamID steamIDClan) -> const char *;
//     fn ISteamFriends_GetClanActivityCounts(CSteamID steamIDClan, c_int *pnOnline, c_int *pnInGame, c_int *pnChatting) -> bool;
//     fn ICall_t ISteamFriends_DownloadClanActivityCounts(CSteamID *psteamIDClans, c_int cClansToRequest) -> SteamA;
//     fn ISteamFriends_GetFriendCountFromSource(CSteamID steamIDSource) -> c_int;
//     fn ID_t ISteamFriends_GetFriendFromSourceByIndex(CSteamID steamIDSource, c_int iFriend) -> Stea;
...
//     fn ISteamFriends_GetSmallFriendAvatar(CSteamID steamIDFriend) -> c_int;
//     fn ISteamFriends_GetMediumFriendAvatar(CSteamID steamIDFriend) -> c_int;
//     fn ISteamFriends_GetLargeFriendAvatar(CSteamID steamIDFriend) -> c_int;
...
//     fn ISteamFriends_GetClanOfficerCount(CSteamID steamIDClan) -> c_int;
//     fn ID_t ISteamFriends_GetClanOfficerByIndex(CSteamID steamIDClan, c_int iOfficer) -> Stea;
//     fn ISteamFriends_GetUserRestrictions() -> u32;
...
//     fn ISteamFriends_GetFriendRichPresenceKeyCount(CSteamID steamIDFriend) -> c_int;
//     fn ISteamFriends_GetFriendRichPresenceKeyByIndex(CSteamID steamIDFriend, c_int iKey) -> const char *;
...
//     fn ISteamFriends_GetCoplayFriendCount() -> c_int;
//     fn ID_t ISteamFriends_GetCoplayFriend(c_int iCoplayFriend) -> Stea;
//     fn ISteamFriends_GetFriendCoplayTime(CSteamID steamIDFriend) -> c_int;
...
//     fn ISteamFriends_GetClanChatMemberCount(CSteamID steamIDClan) -> c_int;
//     fn ID_t ISteamFriends_GetChatMemberByIndex(CSteamID steamIDClan, c_int iUser) -> Stea;
//     fn ISteamFriends_SendClanChatMessage(CSteamID steamIDClanChat, const char *pchText) -> bool;
//     fn ISteamFriends_GetClanChatMessage(CSteamID steamIDClanChat, c_int iMessage, void *prgchText, c_int cchTextMax, EChatEntryType *peChatEntryType, CSteamID *psteamidChatter) -> c_int;
...
//     fn ISteamFriends_GetFriendMessage(CSteamID steamIDFriend, c_int iMessageID, void *pvData, c_int cubData, EChatEntryType *peChatEntryType) -> c_int;
...
//     fn ICall_t ISteamFriends_EnumerateFollowingList(u32 unStartIndex) -> SteamA;
//     fn ISteamGameServer_InitGameServer(u32 unIP, u16 usGamePort, u16 usQueryPort, u32 unFlags, AppId_t nGameAppId, const char *pchVersionString) -> bool;
...
//     fn ISteamGameServer_SetMaxPlayerCount(c_int cPlayersMax) -> void;
//     fn ISteamGameServer_SetBotPlayerCount(c_int cBotplayers) -> void;
...
//     fn ISteamGameServer_SetSpectatorPort(u16 unSpectatorPort) -> void;
...
//     fn ISteamGameServer_SendUserConnectAndAuthenticate(u32 unIPClient, const void *pvAuthBlob, u32 cubAuthBlobSize, CSteamID *pSteamIDUser) -> bool;
...
//     fn ISteamGameServer_BUpdateUserData(CSteamID steamIDUser, const char *pchPlayerName, u32 uScore) -> bool;
//     fn ISteamGameServer_GetAuthSessionTicket(void *pTicket, c_int cbMaxTicket, u32 *pcbTicket) -> HAuthTicket;
//     fn ISteamGameServer_BeginAuthSession(const void *pAuthTicket, c_int cbAuthTicket, CSteamID steamID) -> EBeginAuthSessionResult;
...
//     fn ISteamGameServer_GetPublicIP() -> u32;
//     fn ISteamGameServer_HandleIncomingPacket(const void *pData, c_int cbData, u32 srcIP, u16 srcPort) -> bool;
//     fn ISteamGameServer_GetNextOutgoingPacket(void *pOut, c_int cbMaxOut, u32 *pNetAdr, u16 *pPort) -> c_int;
//     fn ISteamGameServer_EnableHeartbeats(bool bActive) -> void;
//     fn ISteamGameServer_SetHeartbeatInterval(c_int iHeartbeatInterval) -> void;
...
//     fn ISteamGameServerStats_GetUserStat(CSteamID steamIDUser, const char *pchName, c_int32 *pData) -> bool;
...
//     fn ISteamGameServerStats_SetUserStat(CSteamID steamIDUser, const char *pchName, c_int32 nData) -> bool;
...
//     fn ISteamHTMLSurface_SetSize(HHTMLBrowser unBrowserHandle, u32 unWidth, u32 unHeight) -> void;
...
//     fn ISteamHTMLSurface_MouseMove(HHTMLBrowser unBrowserHandle, c_int x, c_int y) -> void;
//     fn ISteamHTMLSurface_MouseWheel(HHTMLBrowser unBrowserHandle, c_int32 nDelta) -> void;
//     fn ISteamHTMLSurface_KeyDown(HHTMLBrowser unBrowserHandle, u32 nNativeKeyCode, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) -> void;
//     fn ISteamHTMLSurface_KeyUp(HHTMLBrowser unBrowserHandle, u32 nNativeKeyCode, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) -> void;
//     fn ISteamHTMLSurface_KeyChar(HHTMLBrowser unBrowserHandle, u32 cUnicodeChar, ISteamHTMLSurface::EHTMLKeyModifiers eHTMLKeyModifiers) -> void;
//     fn ISteamHTMLSurface_SetHorizontalScroll(HHTMLBrowser unBrowserHandle, u32 nAbsolutePixelScroll) -> void;
//     fn ISteamHTMLSurface_SetVerticalScroll(HHTMLBrowser unBrowserHandle, u32 nAbsolutePixelScroll) -> void;
...
//     fn ISteamHTMLSurface_GetLinkAtPosition(HHTMLBrowser unBrowserHandle, c_int x, c_int y) -> void;
...
//     fn ISteamHTMLSurface_SetPageScaleFactor(HHTMLBrowser unBrowserHandle, float flZoom, c_int nPoc_intX, c_int nPoc_intY) -> void;
...
//     fn ISteamHTTP_SetHTTPRequestContextValue(HTTPRequestHandle hRequest, uc_int64 ulContextValue) -> bool;
//     fn ISteamHTTP_SetHTTPRequestNetworkActivityTimeout(HTTPRequestHandle hRequest, u32 unTimeoutSeconds) -> bool;
...
//     fn ISteamHTTP_GetHTTPResponseHeaderSize(HTTPRequestHandle hRequest, const char *pchHeaderName, u32 *unResponseHeaderSize) -> bool;
//     fn ISteamHTTP_GetHTTPResponseHeaderValue(HTTPRequestHandle hRequest, const char *pchHeaderName, uc_int8 *pHeaderValueBuffer, u32 unBufferSize) -> bool;
//     fn ISteamHTTP_GetHTTPResponseBodySize(HTTPRequestHandle hRequest, u32 *unBodySize) -> bool;
//     fn ISteamHTTP_GetHTTPResponseBodyData(HTTPRequestHandle hRequest, uc_int8 *pBodyDataBuffer, u32 unBufferSize) -> bool;
//     fn ISteamHTTP_GetHTTPStreamingResponseBodyData(HTTPRequestHandle hRequest, u32 cOffset, uc_int8 *pBodyDataBuffer, u32 unBufferSize) -> bool;
...
//     fn ISteamHTTP_SetHTTPRequestRawPostBody(HTTPRequestHandle hRequest, const char *pchContentType, uc_int8 *pubBody, u32 unBodyLen) -> bool;
...
//     fn ISteamHTTP_SetHTTPRequestAbsoluteTimeoutMS(HTTPRequestHandle hRequest, u32 unMilliseconds) -> bool;
...
//     fn ISteamInventory_GetResultItems(SteamInventoryResult_t resultHandle, SteamItemDetails_t *pOutItemsArray, u32 *punOutItemsArraySize) -> bool;
//     fn ISteamInventory_GetResultTimestamp(SteamInventoryResult_t resultHandle) -> u32;
...
//     fn ISteamInventory_GetItemsByID(SteamInventoryResult_t *pResultHandle, const SteamItemInstanceID_t *pInstanceIDs, u32 unCountInstanceIDs) -> bool;
//     fn ISteamInventory_SerializeResult(SteamInventoryResult_t resultHandle, void *pOutBuffer, u32 *punOutBufferSize) -> bool;
//     fn ISteamInventory_DeserializeResult(SteamInventoryResult_t *pOutResultHandle, const void *pBuffer, u32 unBufferSize, bool bRESERVED_MUST_BE_FALSE = false) -> bool;
//     fn ISteamInventory_GenerateItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, const u32 *punArrayQuantity, u32 unArrayLength) -> bool;
...
//     fn ISteamInventory_AddPromoItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, u32 unArrayLength) -> bool;
//     fn ISteamInventory_ConsumeItem(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemConsume, u32 unQuantity) -> bool;
//     fn ISteamInventory_ExchangeItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayGenerate, const u32 *punArrayGenerateQuantity, u32 unArrayGenerateLength, const SteamItemInstanceID_t *pArrayDestroy, const u32 *punArrayDestroyQuantity, u32 unArrayDestroyLength) -> bool;
//     fn ISteamInventory_TransferItemQuantity(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemIdSource, u32 unQuantity, SteamItemInstanceID_t itemIdDest) -> bool;
...
//     fn ISteamInventory_TradeItems(SteamInventoryResult_t *pResultHandle, CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, const u32 *pArrayGiveQuantity, u32 nArrayGiveLength, const SteamItemInstanceID_t *pArrayGet, const u32 *pArrayGetQuantity, u32 nArrayGetLength) -> bool;
//     fn ISteamInventory_LoadItemDefinitions() -> bool;
//     fn ISteamInventory_GetItemDefinitionIDs(SteamItemDef_t *pItemDefIDs, u32 *punItemDefIDsArraySize) -> bool;
//     fn ISteamInventory_GetItemDefinitionProperty(SteamItemDef_t iDefinition, const char *pchPropertyName, char *pchValueBuffer, u32 *punValueBufferSize) -> bool;
//     fn ISteamMatchmaking_GetFavoriteGameCount() -> c_int;
//     fn ISteamMatchmaking_GetFavoriteGame(c_int iGame, AppId_t *pnAppID, u32 *pnIP, u16 *pnConnPort, u16 *pnQueryPort, u32 *punFlags, u32 *pRTime32LastPlayedOnServer) -> bool;
//     fn ISteamMatchmaking_AddFavoriteGame(AppId_t nAppID, u32 nIP, u16 nConnPort, u16 nQueryPort, u32 unFlags, u32 rTime32LastPlayedOnServer) -> c_int;
//     fn ISteamMatchmaking_RemoveFavoriteGame(AppId_t nAppID, u32 nIP, u16 nConnPort, u16 nQueryPort, u32 unFlags) -> bool;
...
//     fn ISteamMatchmaking_AddRequestLobbyListNumericalFilter(const char *pchKeyToMatch, c_int nValueToMatch, ELobbyComparison eComparisonType) -> void;
//     fn ISteamMatchmaking_AddRequestLobbyListNearValueFilter(const char *pchKeyToMatch, c_int nValueToBeCloseTo) -> void;
//     fn ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable(c_int nSlotsAvailable) -> void;
//     fn ISteamMatchmaking_AddRequestLobbyListDistanceFilter(ELobbyDistanceFilter eLobbyDistanceFilter) -> void;
//     fn ISteamMatchmaking_AddRequestLobbyListResultCountFilter(c_int cMaxResults) -> void;
//     fn ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter(CSteamID steamIDLobby) -> void;
//     fn ID_t ISteamMatchmaking_GetLobbyByIndex(c_int iLobby) -> Stea;
//     fn ICall_t ISteamMatchmaking_CreateLobby(ELobbyType eLobbyType, c_int cMaxMembers) -> SteamA;
...
//     fn ISteamMatchmaking_GetNumLobbyMembers(CSteamID steamIDLobby) -> c_int;
//     fn ID_t ISteamMatchmaking_GetLobbyMemberByIndex(CSteamID steamIDLobby, c_int iMember) -> Stea;
...
//     fn ISteamMatchmaking_GetLobbyDataCount(CSteamID steamIDLobby) -> c_int;
//     fn ISteamMatchmaking_GetLobbyDataByIndex(CSteamID steamIDLobby, c_int iLobbyData, char *pchKey, c_int cchKeyBufferSize, char *pchValue, c_int cchValueBufferSize) -> bool;
...
//     fn ISteamMatchmaking_SendLobbyChatMsg(CSteamID steamIDLobby, const void *pvMsgBody, c_int cubMsgBody) -> bool;
//     fn ISteamMatchmaking_GetLobbyChatEntry(CSteamID steamIDLobby, c_int iChatID, CSteamID *pSteamIDUser, void *pvData, c_int cubData, EChatEntryType *peChatEntryType) -> c_int;
//     fn ISteamMatchmaking_RequestLobbyData(CSteamID steamIDLobby) -> bool;
//     fn ISteamMatchmaking_SetLobbyGameServer(CSteamID steamIDLobby, u32 unGameServerIP, u16 unGameServerPort, CSteamID steamIDGameServer) -> void;
//     fn ISteamMatchmaking_GetLobbyGameServer(CSteamID steamIDLobby, u32 *punGameServerIP, u16 *punGameServerPort, CSteamID *psteamIDGameServer) -> bool;
//     fn ISteamMatchmaking_SetLobbyMemberLimit(CSteamID steamIDLobby, c_int cMaxMembers) -> bool;
//     fn ISteamMatchmaking_GetLobbyMemberLimit(CSteamID steamIDLobby) -> c_int;
...
//     fn ISteamMatchmaking_CheckForPSNGameBootInvite(unsigned c_int iGameBootAttributes) -> void;
//     fn ISteamMatchmakingServers_RequestInternetServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, u32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse) -> HServerListRequest;
...
//     fn ISteamMatchmakingServers_RequestFriendsServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, u32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse) -> HServerListRequest;
//     fn ISteamMatchmakingServers_RequestFavoritesServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, u32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse) -> HServerListRequest;
//     fn ISteamMatchmakingServers_RequestHistoryServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, u32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse) -> HServerListRequest;
//     fn ISteamMatchmakingServers_RequestSpectatorServerList(AppId_t iApp, MatchMakingKeyValuePair_t **ppchFilters, u32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse) -> HServerListRequest;
//     fn ISteamMatchmakingServers_ReleaseRequest(HServerListRequest hServerListRequest) -> void;
//     fn ISteamMatchmakingServers_GetServerDetails(HServerListRequest hRequest, c_int iServer) -> gameserveritem_t *;
...
//     fn ISteamMatchmakingServers_GetServerCount(HServerListRequest hRequest) -> c_int;
//     fn ISteamMatchmakingServers_RefreshServer(HServerListRequest hRequest, c_int iServer) -> void;
//     fn ISteamMatchmakingServers_PingServer(u32 unIP, u16 usPort, ISteamMatchmakingPingResponse *pRequestServersResponse) -> HServerQuery;
//     fn ISteamMatchmakingServers_PlayerDetails(u32 unIP, u16 usPort, ISteamMatchmakingPlayersResponse *pRequestServersResponse) -> HServerQuery;
//     fn ISteamMatchmakingServers_ServerRules(u32 unIP, u16 usPort, ISteamMatchmakingRulesResponse *pRequestServersResponse) -> HServerQuery;
...
//     fn ISteamMusicRemote_SetPNGIcon_64x64(void *pvBuffer, u32 cbBufferLength) -> bool;
...
//     fn ISteamMusicRemote_UpdateCurrentEntryElapsedSeconds(c_int nValue) -> bool;
//     fn ISteamMusicRemote_UpdateCurrentEntryCoverArt(void *pvBuffer, u32 cbBufferLength) -> bool;
...
//     fn ISteamMusicRemote_SetQueueEntry(c_int nID, c_int nPosition, const char *pchEntryText) -> bool;
//     fn ISteamMusicRemote_SetCurrentQueueEntry(c_int nID) -> bool;
...
//     fn ISteamMusicRemote_SetPlaylistEntry(c_int nID, c_int nPosition, const char *pchEntryText) -> bool;
//     fn ISteamMusicRemote_SetCurrentPlaylistEntry(c_int nID) -> bool;
//     fn ISteamMusicRemote_PlaylistDidChange() -> bool;
//     fn ISteamNetworking_SendP2PPacket(CSteamID steamIDRemote, const void *pubData, u32 cubData, EP2PSend eP2PSendType, c_int nChannel = 0) -> bool;
//     fn ISteamNetworking_IsP2PPacketAvailable(u32 *pcubMsgSize, c_int nChannel = 0) -> bool;
//     fn ISteamNetworking_ReadP2PPacket(void *pubDest, u32 cubDest, u32 *pcubMsgSize, CSteamID *psteamIDRemote, c_int nChannel = 0) -> bool;
...
//     fn ISteamNetworking_CloseP2PChannelWithUser(CSteamID steamIDRemote, c_int nChannel) -> bool;
...
//     fn ISteamNetworking_CreateListenSocket(c_int nVirtualP2PPort, u32 nIP, u16 nPort, bool bAllowUseOfPacketRelay) -> SNetListenSocket_t;
//     fn ISteamNetworking_CreateP2PConnectionSocket(CSteamID steamIDTarget, c_int nVirtualPort, c_int nTimeoutSec, bool bAllowUseOfPacketRelay) -> SNetSocket_t;
//     fn ISteamNetworking_CreateConnectionSocket(u32 nIP, u16 nPort, c_int nTimeoutSec) -> SNetSocket_t;
...
//     fn ISteamNetworking_SendDataOnSocket(SNetSocket_t hSocket, void *pubData, u32 cubData, bool bReliable) -> bool;
//     fn ISteamNetworking_IsDataAvailableOnSocket(SNetSocket_t hSocket, u32 *pcubMsgSize) -> bool;
//     fn ISteamNetworking_RetrieveDataFromSocket(SNetSocket_t hSocket, void *pubDest, u32 cubDest, u32 *pcubMsgSize) -> bool;
//     fn ISteamNetworking_IsDataAvailable(SNetListenSocket_t hListenSocket, u32 *pcubMsgSize, SNetSocket_t *phSocket) -> bool;
//     fn ISteamNetworking_RetrieveData(SNetListenSocket_t hListenSocket, void *pubDest, u32 cubDest, u32 *pcubMsgSize, SNetSocket_t *phSocket) -> bool;
//     fn ISteamNetworking_GetSocketInfo(SNetSocket_t hSocket, CSteamID *pSteamIDRemote, c_int *peSocketStatus, u32 *punIPRemote, u16 *punPortRemote) -> bool;
//     fn ISteamNetworking_GetListenSocketInfo(SNetListenSocket_t hListenSocket, u32 *pnIP, u16 *pnPort) -> bool;
//     fn ISteamNetworking_GetSocketConnectionType(SNetSocket_t hSocket) -> ESNetSocketConnectionType;
//     fn ISteamNetworking_GetMaxPacketSize(SNetSocket_t hSocket) -> c_int;
//     fn ISteamRemoteStorage_FileWrite(const char *pchFile, const void *pvData, c_int32 cubData) -> bool;
//     fn ISteamRemoteStorage_FileRead(const char *pchFile, void *pvData, c_int32 cubDataToRead) -> c_int32;
//     fn ICall_t ISteamRemoteStorage_FileWriteAsync(const char *pchFile, const void *pvData, u32 cubData) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_FileReadAsync(const char *pchFile, u32 nOffset, u32 cubToRead) -> SteamA;
//     fn ISteamRemoteStorage_FileReadAsyncComplete(SteamAPICall_t hReadCall, void *pvBuffer, u32 cubToRead) -> bool;
...
//     fn ISteamRemoteStorage_FileWriteStreamWriteChunk(UGCFileWriteStreamHandle_t writeHandle, const void *pvData, c_int32 cubData) -> bool;
...
//     fn ISteamRemoteStorage_GetFileSize(const char *pchFile) -> c_int32;
//     fn ISteamRemoteStorage_GetFileTimestamp(const char *pchFile) -> c_int64;
//     fn ISteamRemoteStorage_GetSyncPlatforms(const char *pchFile) -> ERemoteStoragePlatform;
//     fn ISteamRemoteStorage_GetFileCount() -> c_int32;
//     fn ISteamRemoteStorage_GetFileNameAndSize(c_int iFile, c_int32 *pnFileSizeInBytes) -> const char *;
//     fn ISteamRemoteStorage_GetQuota(c_int32 *pnTotalBytes, c_int32 *puAvailableBytes) -> bool;
...
//     fn ICall_t ISteamRemoteStorage_UGCDownload(UGCHandle_t hContent, u32 unPriority) -> SteamA;
//     fn ISteamRemoteStorage_GetUGCDownloadProgress(UGCHandle_t hContent, c_int32 *pnBytesDownloaded, c_int32 *pnBytesExpected) -> bool;
//     fn ISteamRemoteStorage_GetUGCDetails(UGCHandle_t hContent, AppId_t *pnAppID, char **ppchName, c_int32 *pnFileSizeInBytes, CSteamID *pSteamIDOwner) -> bool;
//     fn ISteamRemoteStorage_UGCRead(UGCHandle_t hContent, void *pvData, c_int32 cubDataToRead, u32 cOffset, EUGCReadAction eAction) -> c_int32;
//     fn ISteamRemoteStorage_GetCachedUGCCount() -> c_int32;
//     fn ISteamRemoteStorage_GetCachedUGCHandle(c_int32 iCachedContent) -> UGCHandle_t;
...
//     fn ICall_t ISteamRemoteStorage_GetPublishedFileDetails(PublishedFileId_t unPublishedFileId, u32 unMaxSecondsOld) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_DeletePublishedFile(PublishedFileId_t unPublishedFileId) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_EnumerateUserPublishedFiles(u32 unStartIndex) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_SubscribePublishedFile(PublishedFileId_t unPublishedFileId) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_EnumerateUserSubscribedFiles(u32 unStartIndex) -> SteamA;
...
//     fn ICall_t ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(CSteamID steamId, u32 unStartIndex, SteamParamStringArray_t *pRequiredTags, SteamParamStringArray_t *pExcludedTags) -> SteamA;
...
//     fn ICall_t ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(EWorkshopFileAction eAction, u32 unStartIndex) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(EWorkshopEnumerationType eEnumerationType, u32 unStartIndex, u32 unCount, u32 unDays, SteamParamStringArray_t *pTags, SteamParamStringArray_t *pUserTags) -> SteamA;
//     fn ICall_t ISteamRemoteStorage_UGCDownloadToLocation(UGCHandle_t hContent, const char *pchLocation, u32 unPriority) -> SteamA;
//     fn ISteamScreenshots_WriteScreenshot(void *pubRGB, u32 cubRGB, c_int nWidth, c_int nHeight) -> ScreenshotHandle;
//     fn ISteamScreenshots_AddScreenshotToLibrary(const char *pchFilename, const char *pchThumbnailFilename, c_int nWidth, c_int nHeight) -> ScreenshotHandle;
...
//     fn ISteamUGC_CreateQueryUserUGCRequest(AccountID_t unAccountID, EUserUGCList eListType, EUGCMatchingUGCType eMatchingUGCType, EUserUGCListSortOrder eSortOrder, AppId_t nCreatorAppID, AppId_t nConsumerAppID, u32 unPage) -> UGCQueryHandle_t;
//     fn ISteamUGC_CreateQueryAllUGCRequest(EUGCQuery eQueryType, EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType, AppId_t nCreatorAppID, AppId_t nConsumerAppID, u32 unPage) -> UGCQueryHandle_t;
//     fn ISteamUGC_CreateQueryUGCDetailsRequest(PublishedFileId_t *pvecPublishedFileID, u32 unNumPublishedFileIDs) -> UGCQueryHandle_t;
//     fn ICall_t ISteamUGC_SendQueryUGCRequest(UGCQueryHandle_t handle) -> SteamA;
//     fn ISteamUGC_GetQueryUGCResult(UGCQueryHandle_t handle, u32 index, SteamUGCDetails_t *pDetails) -> bool;
//     fn ISteamUGC_GetQueryUGCPreviewURL(UGCQueryHandle_t handle, u32 index, char *pchURL, u32 cchURLSize) -> bool;
//     fn ISteamUGC_GetQueryUGCMetadata(UGCQueryHandle_t handle, u32 index, char *pchMetadata, u32 cchMetadatasize) -> bool;
//     fn ISteamUGC_GetQueryUGCChildren(UGCQueryHandle_t handle, u32 index, PublishedFileId_t* pvecPublishedFileID, u32 cMaxEntries) -> bool;
//     fn ISteamUGC_GetQueryUGCStatistic(UGCQueryHandle_t handle, u32 index, EItemStatistic eStatType, u32 *pStatValue) -> bool;
//     fn ISteamUGC_GetQueryUGCNumAdditionalPreviews(UGCQueryHandle_t handle, u32 index) -> u32;
//     fn ISteamUGC_GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, u32 index, u32 previewIndex, char *pchURLOrVideoID, u32 cchURLSize, bool *pbIsImage) -> bool;
//     fn ISteamUGC_GetQueryUGCNumKeyValueTags(UGCQueryHandle_t handle, u32 index) -> u32;
//     fn ISteamUGC_GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, u32 index, u32 keyValueTagIndex, char *pchKey, u32 cchKeySize, char *pchValue, u32 cchValueSize) -> bool;
...
//     fn ISteamUGC_SetAllowCachedResponse(UGCQueryHandle_t handle, u32 unMaxAgeSeconds) -> bool;
...
//     fn ISteamUGC_SetRankedByTrendDays(UGCQueryHandle_t handle, u32 unDays) -> bool;
//     fn ISteamUGC_AddRequiredKeyValueTag(UGCQueryHandle_t handle, const char *pKey, const char *pValue) -> bool;
//     fn ICall_t ISteamUGC_RequestUGCDetails(PublishedFileId_t nPublishedFileID, u32 unMaxAgeSeconds) -> SteamA;
...
//     fn ItemUpdateStatus ISteamUGC_GetItemUpdateProgress(UGCUpdateHandle_t handle, uc_int64 *punBytesProcessed, uc_int64* punBytesTotal) -> ;
...
//     fn ISteamUGC_GetNumSubscribedItems() -> u32;
//     fn ISteamUGC_GetSubscribedItems(PublishedFileId_t* pvecPublishedFileID, u32 cMaxEntries) -> u32;
//     fn ISteamUGC_GetItemState(PublishedFileId_t nPublishedFileID) -> u32;
//     fn ISteamUGC_GetItemInstallInfo(PublishedFileId_t nPublishedFileID, uc_int64 *punSizeOnDisk, char *pchFolder, u32 cchFolderSize, u32 *punTimeStamp) -> bool;
//     fn ISteamUGC_GetItemDownloadInfo(PublishedFileId_t nPublishedFileID, uc_int64 *punBytesDownloaded, uc_int64 *punBytesTotal) -> bool;
...
//     fn ISteamUnifiedMessages_SendMethod(const char *pchServiceMethod, const void *pRequestBuffer, u32 unRequestBufferSize, uc_int64 unContext) -> ClientUnifiedMessageHandle;
//     fn ISteamUnifiedMessages_GetMethodResponseInfo(ClientUnifiedMessageHandle hHandle, u32 *punResponseSize, EResult *peResult) -> bool;
//     fn ISteamUnifiedMessages_GetMethodResponseData(ClientUnifiedMessageHandle hHandle, void *pResponseBuffer, u32 unResponseBufferSize, bool bAutoRelease) -> bool;
//     fn ISteamUnifiedMessages_ReleaseMethod(ClientUnifiedMessageHandle hHandle) -> bool;
//     fn ISteamUnifiedMessages_SendNotification(const char *pchServiceNotification, const void *pNotificationBuffer, u32 unNotificationBufferSize) -> bool;
//     fn ISteamUser_GetHSteamUser() -> HSteamUser;
//     fn ISteamUser_BLoggedOn() -> bool;
//     fn ID_t ISteamUser_GetSteamID() -> Stea;
//     fn ISteamUser_InitiateGameConnection(void *pAuthBlob, c_int cbMaxAuthBlob, CSteamID steamIDGameServer, u32 unIPServer, u16 usPortServer, bool bSecure) -> c_int;
//     fn ISteamUser_TerminateGameConnection(u32 unIPServer, u16 usPortServer) -> void;
//     fn ISteamUser_TrackAppUsageEvent(CGameID gameID, c_int eAppUsageEvent, const char *pchExtraInfo = "") -> void;
//     fn ISteamUser_GetUserDataFolder(char *pchBuffer, c_int cubBuffer) -> bool;
//     fn ISteamUser_StartVoiceRecording() -> void;
//     fn ISteamUser_StopVoiceRecording() -> void;
//     fn ISteamUser_GetAvailableVoice(u32 *pcbCompressed, u32 *pcbUncompressed, u32 nUncompressedVoiceDesiredSampleRate) -> EVoiceResult;
//     fn ISteamUser_GetVoice(bool bWantCompressed, void *pDestBuffer, u32 cbDestBufferSize, u32 *nBytesWritten, bool bWantUncompressed, void *pUncompressedDestBuffer, u32 cbUncompressedDestBufferSize, u32 *nUncompressBytesWritten, u32 nUncompressedVoiceDesiredSampleRate) -> EVoiceResult;
//     fn ISteamUser_DecompressVoice(const void *pCompressed, u32 cbCompressed, void *pDestBuffer, u32 cbDestBufferSize, u32 *nBytesWritten, u32 nDesiredSampleRate) -> EVoiceResult;
//     fn ISteamUser_GetVoiceOptimalSampleRate() -> u32;
//     fn ISteamUser_GetAuthSessionTicket(void *pTicket, c_int cbMaxTicket, u32 *pcbTicket) -> HAuthTicket;
//     fn ISteamUser_BeginAuthSession(const void *pAuthTicket, c_int cbAuthTicket, CSteamID steamID) -> EBeginAuthSessionResult;
...
//     fn ISteamUser_AdvertiseGame(CSteamID steamIDGameServer, u32 unIPServer, u16 usPortServer) -> void;
//     fn ICall_t ISteamUser_RequestEncryptedAppTicket(void *pDataToInclude, c_int cbDataToInclude) -> SteamA;
//     fn ISteamUser_GetEncryptedAppTicket(void *pTicket, c_int cbMaxTicket, u32 *pcbTicket) -> bool;
//     fn ISteamUser_GetGameBadgeLevel(c_int nSeries, bool bFoil) -> c_int;
//     fn ISteamUser_GetPlayerSteamLevel() -> c_int;
...
//     fn ISteamUserStats_GetStat(const char *pchName, c_int32 *pData) -> bool;
//     fn ISteamUserStats_GetStat_(const char *pchName, float *pData) -> bool;
//     fn ISteamUserStats_SetStat(const char *pchName, c_int32 nData) -> bool;
...
//     fn ISteamUserStats_GetAchievementAndUnlockTime(const char *pchName, bool *pbAchieved, u32 *punUnlockTime) -> bool;
//     fn ISteamUserStats_StoreStats() -> bool;
//     fn ISteamUserStats_GetAchievementIcon(const char *pchName) -> c_int;
//     fn ISteamUserStats_GetAchievementDisplayAttribute(const char *pchName, const char *pchKey) -> const char *;
//     fn ISteamUserStats_IndicateAchievementProgress(const char *pchName, u32 nCurProgress, u32 nMaxProgress) -> bool;
//     fn ISteamUserStats_GetNumAchievements() -> u32;
//     fn ISteamUserStats_GetAchievementName(u32 iAchievement) -> const char *;
//     fn ICall_t ISteamUserStats_RequestUserStats(CSteamID steamIDUser) -> SteamA;
//     fn ISteamUserStats_GetUserStat(CSteamID steamIDUser, const char *pchName, c_int32 *pData) -> bool;
...
//     fn ISteamUserStats_GetUserAchievementAndUnlockTime(CSteamID steamIDUser, const char *pchName, bool *pbAchieved, u32 *punUnlockTime) -> bool;
...
//     fn ISteamUserStats_GetLeaderboardEntryCount(SteamLeaderboard_t hSteamLeaderboard) -> c_int;
...
//     fn ICall_t ISteamUserStats_DownloadLeaderboardEntries(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest, c_int nRangeStart, c_int nRangeEnd) -> SteamA;
//     fn ICall_t ISteamUserStats_DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard, CSteamID *prgUsers, c_int cUsers) -> SteamA;
//     fn ISteamUserStats_GetDownloadedLeaderboardEntry(SteamLeaderboardEntries_t hSteamLeaderboardEntries, c_int index, LeaderboardEntry_t *pLeaderboardEntry, c_int32 *pDetails, c_int cDetailsMax) -> bool;
//     fn ICall_t ISteamUserStats_UploadLeaderboardScore(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, c_int32 nScore, const c_int32 *pScoreDetails, c_int cScoreDetailsCount) -> SteamA;
...
//     fn ISteamUserStats_GetMostAchievedAchievementInfo(char *pchName, u32 unNameBufLen, float *pflPercent, bool *pbAchieved) -> c_int;
//     fn ISteamUserStats_GetNextMostAchievedAchievementInfo(c_int iIteratorPrevious, char *pchName, u32 unNameBufLen, float *pflPercent, bool *pbAchieved) -> c_int;
//     fn ISteamUserStats_GetAchievementAchievedPercent(const char *pchName, float *pflPercent) -> bool;
//     fn ICall_t ISteamUserStats_RequestGlobalStats(c_int nHistoryDays) -> SteamA;
//     fn ISteamUserStats_GetGlobalStat(const char *pchStatName, c_int64 *pData) -> bool;
//     fn ISteamUserStats_GetGlobalStat_(const char *pchStatName, double *pData) -> bool;
//     fn ISteamUserStats_GetGlobalStatHistory(const char *pchStatName, c_int64 *pData, u32 cubData) -> c_int32;
//     fn ISteamUserStats_GetGlobalStatHistory_(const char *pchStatName, double *pData, u32 cubData) -> c_int32;
//     fn ISteamUserStats_InstallPS3Trophies() -> bool;
//     fn ISteamUserStats_GetTrophySpaceRequiredBeforeInstall() -> uc_int64;
//     fn ISteamUserStats_SetUserStatsData(const void *pvData, u32 cubData) -> bool;
//     fn ISteamUserStats_GetUserStatsData(void *pvData, u32 cubData, u32 *pcubWritten) -> bool;
//     fn ISteamUtils_GetSecondsSinceAppActive() -> u32;
//     fn ISteamUtils_GetSecondsSinceComputerActive() -> u32;
//     fn ISteamUtils_GetConnectedUniverse() -> EUniverse;
//     fn ISteamUtils_GetServerRealTime() -> u32;
//     fn ISteamUtils_GetIPCountry() -> const char *;
//     fn ISteamUtils_GetImageSize(c_int iImage, u32 *pnWidth, u32 *pnHeight) -> bool;
//     fn ISteamUtils_GetImageRGBA(c_int iImage, uc_int8 *pubDest, c_int nDestBufferSize) -> bool;
//     fn ISteamUtils_GetCSERIPPort(u32 *unIP, u16 *usPort) -> bool;
//     fn ISteamUtils_GetCurrentBatteryPower() -> uc_int8;
//     fn ISteamUtils_GetAppID() -> u32;
...
//     fn ISteamUtils_GetAPICallResult(SteamAPICall_t hSteamAPICall, void *pCallback, c_int cubCallback, c_int iCallbackExpected, bool *pbFailed) -> bool;
//     fn ISteamUtils_RunFrame() -> void;
//     fn ISteamUtils_GetIPCCallCount() -> u32;
...
//     fn ISteamUtils_PostPS3SysutilCallback(uc_int64_t status, uc_int64_t param, void* userdata) -> void;
...
//     fn ISteamUtils_ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, const char *pchDescription, u32 unCharMax, const char *pchExistingText) -> bool;
//     fn ISteamUtils_GetEnteredGamepadTextLength() -> u32;
//     fn ISteamUtils_GetEnteredGamepadTextInput(char *pchText, u32 cchText) -> bool;
//     fn ISteamUtils_GetSteamUILanguage() -> const char *;
//     fn ISteamUtils_IsSteamRunningInVR() -> bool;
//     fn ISteamUtils_SetOverlayNotificationInset(c_int nHorizontalInset, c_int nVerticalInset) -> void;
//     fn ISteamVideo_GetVideoURL(AppId_t unVideoAppID) -> void;
//     fn ISteamVideo_IsBroadcasting(c_int *pnNumViewers) -> bool;
//     fn ISteamGameServerHTTP_CreateHTTPRequest(EHTTPMethod eHTTPRequestMethod, const char *pchAbsoluteURL) -> HTTPRequestHandle;
//     fn ISteamGameServerHTTP_SetHTTPRequestContextValue(HTTPRequestHandle hRequest, uc_int64 ulContextValue) -> bool;
//     fn ISteamGameServerHTTP_SetHTTPRequestNetworkActivityTimeout(HTTPRequestHandle hRequest, u32 unTimeoutSeconds) -> bool;
...
//     fn ISteamGameServerHTTP_GetHTTPResponseHeaderSize(HTTPRequestHandle hRequest, const char *pchHeaderName, u32 *unResponseHeaderSize) -> bool;
//     fn ISteamGameServerHTTP_GetHTTPResponseHeaderValue(HTTPRequestHandle hRequest, const char *pchHeaderName, uc_int8 *pHeaderValueBuffer, u32 unBufferSize) -> bool;
//     fn ISteamGameServerHTTP_GetHTTPResponseBodySize(HTTPRequestHandle hRequest, u32 *unBodySize) -> bool;
//     fn ISteamGameServerHTTP_GetHTTPResponseBodyData(HTTPRequestHandle hRequest, uc_int8 *pBodyDataBuffer, u32 unBufferSize) -> bool;
//     fn ISteamGameServerHTTP_GetHTTPStreamingResponseBodyData(HTTPRequestHandle hRequest, u32 cOffset, uc_int8 *pBodyDataBuffer, u32 unBufferSize) -> bool;
...
//     fn ISteamGameServerHTTP_SetHTTPRequestRawPostBody(HTTPRequestHandle hRequest, const char *pchContentType, uc_int8 *pubBody, u32 unBodyLen) -> bool;
...
//     fn ISteamGameServerHTTP_SetHTTPRequestAbsoluteTimeoutMS(HTTPRequestHandle hRequest, u32 unMilliseconds) -> bool;
...
//     fn ISteamGameServerInventory_GetResultItems(SteamInventoryResult_t resultHandle, SteamItemDetails_t *pOutItemsArray, u32 *punOutItemsArraySize) -> bool;
//     fn ISteamGameServerInventory_GetResultTimestamp(SteamInventoryResult_t resultHandle) -> u32;
...
//     fn ISteamGameServerInventory_GetItemsByID(SteamInventoryResult_t *pResultHandle, const SteamItemInstanceID_t *pInstanceIDs, u32 unCountInstanceIDs) -> bool;
//     fn ISteamGameServerInventory_SerializeResult(SteamInventoryResult_t resultHandle, void *pOutBuffer, u32 *punOutBufferSize) -> bool;
//     fn ISteamGameServerInventory_DeserializeResult(SteamInventoryResult_t *pOutResultHandle, const void *pBuffer, u32 unBufferSize, bool bRESERVED_MUST_BE_FALSE = false) -> bool;
//     fn ISteamGameServerInventory_GenerateItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, const u32 *punArrayQuantity, u32 unArrayLength) -> bool;
...
//     fn ISteamGameServerInventory_AddPromoItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, u32 unArrayLength) -> bool;
//     fn ISteamGameServerInventory_ConsumeItem(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemConsume, u32 unQuantity) -> bool;
//     fn ISteamGameServerInventory_ExchangeItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayGenerate, const u32 *punArrayGenerateQuantity, u32 unArrayGenerateLength, const SteamItemInstanceID_t *pArrayDestroy, const u32 *punArrayDestroyQuantity, u32 unArrayDestroyLength) -> bool;
//     fn ISteamGameServerInventory_TransferItemQuantity(SteamInventoryResult_t *pResultHandle, SteamItemInstanceID_t itemIdSource, u32 unQuantity, SteamItemInstanceID_t itemIdDest) -> bool;
...
//     fn ISteamGameServerInventory_TradeItems(SteamInventoryResult_t *pResultHandle, CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, const u32 *pArrayGiveQuantity, u32 nArrayGiveLength, const SteamItemInstanceID_t *pArrayGet, const u32 *pArrayGetQuantity, u32 nArrayGetLength) -> bool;
//     fn ISteamGameServerInventory_LoadItemDefinitions() -> bool;
//     fn ISteamGameServerInventory_GetItemDefinitionIDs(SteamItemDef_t *pItemDefIDs, u32 *punItemDefIDsArraySize) -> bool;
//     fn ISteamGameServerInventory_GetItemDefinitionProperty(SteamItemDef_t iDefinition, const char *pchPropertyName, char *pchValueBuffer, u32 *punValueBufferSize) -> bool;
//     fn ISteamGameServerNetworking_SendP2PPacket(CSteamID steamIDRemote, const void *pubData, u32 cubData, EP2PSend eP2PSendType, c_int nChannel = 0) -> bool;
//     fn ISteamGameServerNetworking_IsP2PPacketAvailable(u32 *pcubMsgSize, c_int nChannel = 0) -> bool;
//     fn ISteamGameServerNetworking_ReadP2PPacket(void *pubDest, u32 cubDest, u32 *pcubMsgSize, CSteamID *psteamIDRemote, c_int nChannel = 0) -> bool;
...
//     fn ISteamGameServerNetworking_CloseP2PChannelWithUser(CSteamID steamIDRemote, c_int nChannel) -> bool;
...
//     fn ISteamGameServerNetworking_CreateListenSocket(c_int nVirtualP2PPort, u32 nIP, u16 nPort, bool bAllowUseOfPacketRelay) -> SNetListenSocket_t;
//     fn ISteamGameServerNetworking_CreateP2PConnectionSocket(CSteamID steamIDTarget, c_int nVirtualPort, c_int nTimeoutSec, bool bAllowUseOfPacketRelay) -> SNetSocket_t;
//     fn ISteamGameServerNetworking_CreateConnectionSocket(u32 nIP, u16 nPort, c_int nTimeoutSec) -> SNetSocket_t;
...
//     fn ISteamGameServerNetworking_SendDataOnSocket(SNetSocket_t hSocket, void *pubData, u32 cubData, bool bReliable) -> bool;
//     fn ISteamGameServerNetworking_IsDataAvailableOnSocket(SNetSocket_t hSocket, u32 *pcubMsgSize) -> bool;
//     fn ISteamGameServerNetworking_RetrieveDataFromSocket(SNetSocket_t hSocket, void *pubDest, u32 cubDest, u32 *pcubMsgSize) -> bool;
//     fn ISteamGameServerNetworking_IsDataAvailable(SNetListenSocket_t hListenSocket, u32 *pcubMsgSize, SNetSocket_t *phSocket) -> bool;
//     fn ISteamGameServerNetworking_RetrieveData(SNetListenSocket_t hListenSocket, void *pubDest, u32 cubDest, u32 *pcubMsgSize, SNetSocket_t *phSocket) -> bool;
//     fn ISteamGameServerNetworking_GetSocketInfo(SNetSocket_t hSocket, CSteamID *pSteamIDRemote, c_int *peSocketStatus, u32 *punIPRemote, u16 *punPortRemote) -> bool;
//     fn ISteamGameServerNetworking_GetListenSocketInfo(SNetListenSocket_t hListenSocket, u32 *pnIP, u16 *pnPort) -> bool;
//     fn ISteamGameServerNetworking_GetSocketConnectionType(SNetSocket_t hSocket) -> ESNetSocketConnectionType;
//     fn ISteamGameServerNetworking_GetMaxPacketSize(SNetSocket_t hSocket) -> c_int;
//     fn ISteamGameServerUGC_CreateQueryUserUGCRequest(AccountID_t unAccountID, EUserUGCList eListType, EUGCMatchingUGCType eMatchingUGCType, EUserUGCListSortOrder eSortOrder, AppId_t nCreatorAppID, AppId_t nConsumerAppID, u32 unPage) -> UGCQueryHandle_t;
//     fn ISteamGameServerUGC_CreateQueryAllUGCRequest(EUGCQuery eQueryType, EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType, AppId_t nCreatorAppID, AppId_t nConsumerAppID, u32 unPage) -> UGCQueryHandle_t;
//     fn ISteamGameServerUGC_CreateQueryUGCDetailsRequest(PublishedFileId_t *pvecPublishedFileID, u32 unNumPublishedFileIDs) -> UGCQueryHandle_t;
//     fn ICall_t ISteamGameServerUGC_SendQueryUGCRequest(UGCQueryHandle_t handle) -> SteamA;
//     fn ISteamGameServerUGC_GetQueryUGCResult(UGCQueryHandle_t handle, u32 index, SteamUGCDetails_t *pDetails) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCPreviewURL(UGCQueryHandle_t handle, u32 index, char *pchURL, u32 cchURLSize) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCMetadata(UGCQueryHandle_t handle, u32 index, char *pchMetadata, u32 cchMetadatasize) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCChildren(UGCQueryHandle_t handle, u32 index, PublishedFileId_t* pvecPublishedFileID, u32 cMaxEntries) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCStatistic(UGCQueryHandle_t handle, u32 index, EItemStatistic eStatType, u32 *pStatValue) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCNumAdditionalPreviews(UGCQueryHandle_t handle, u32 index) -> u32;
//     fn ISteamGameServerUGC_GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, u32 index, u32 previewIndex, char *pchURLOrVideoID, u32 cchURLSize, bool *pbIsImage) -> bool;
//     fn ISteamGameServerUGC_GetQueryUGCNumKeyValueTags(UGCQueryHandle_t handle, u32 index) -> u32;
//     fn ISteamGameServerUGC_GetQueryUGCKeyValueTag(UGCQueryHandle_t handle, u32 index, u32 keyValueTagIndex, char *pchKey, u32 cchKeySize, char *pchValue, u32 cchValueSize) -> bool;
...
//     fn ISteamGameServerUGC_SetAllowCachedResponse(UGCQueryHandle_t handle, u32 unMaxAgeSeconds) -> bool;
...
//     fn ISteamGameServerUGC_SetRankedByTrendDays(UGCQueryHandle_t handle, u32 unDays) -> bool;
//     fn ISteamGameServerUGC_AddRequiredKeyValueTag(UGCQueryHandle_t handle, const char *pKey, const char *pValue) -> bool;
//     fn ICall_t ISteamGameServerUGC_RequestUGCDetails(PublishedFileId_t nPublishedFileID, u32 unMaxAgeSeconds) -> SteamA;
...
//     fn ItemUpdateStatus ISteamGameServerUGC_GetItemUpdateProgress(UGCUpdateHandle_t handle, uc_int64 *punBytesProcessed, uc_int64* punBytesTotal) -> ;
...
//     fn ISteamGameServerUGC_GetNumSubscribedItems() -> u32;
//     fn ISteamGameServerUGC_GetSubscribedItems(PublishedFileId_t* pvecPublishedFileID, u32 cMaxEntries) -> u32;
//     fn ISteamGameServerUGC_GetItemState(PublishedFileId_t nPublishedFileID) -> u32;
//     fn ISteamGameServerUGC_GetItemInstallInfo(PublishedFileId_t nPublishedFileID, uc_int64 *punSizeOnDisk, char *pchFolder, u32 cchFolderSize, u32 *punTimeStamp) -> bool;
//     fn ISteamGameServerUGC_GetItemDownloadInfo(PublishedFileId_t nPublishedFileID, uc_int64 *punBytesDownloaded, uc_int64 *punBytesTotal) -> bool;
...
//     fn ISteamGameServerUtils_GetSecondsSinceAppActive() -> u32;
//     fn ISteamGameServerUtils_GetSecondsSinceComputerActive() -> u32;
//     fn ISteamGameServerUtils_GetConnectedUniverse() -> EUniverse;
//     fn ISteamGameServerUtils_GetServerRealTime() -> u32;
//     fn ISteamGameServerUtils_GetIPCountry() -> const char *;
//     fn ISteamGameServerUtils_GetImageSize(c_int iImage, u32 *pnWidth, u32 *pnHeight) -> bool;
//     fn ISteamGameServerUtils_GetImageRGBA(c_int iImage, uc_int8 *pubDest, c_int nDestBufferSize) -> bool;
//     fn ISteamGameServerUtils_GetCSERIPPort(u32 *unIP, u16 *usPort) -> bool;
//     fn ISteamGameServerUtils_GetCurrentBatteryPower() -> uc_int8;
//     fn ISteamGameServerUtils_GetAppID() -> u32;
...
//     fn ISteamGameServerUtils_GetAPICallResult(SteamAPICall_t hSteamAPICall, void *pCallback, c_int cubCallback, c_int iCallbackExpected, bool *pbFailed) -> bool;
//     fn ISteamGameServerUtils_RunFrame() -> void;
//     fn ISteamGameServerUtils_GetIPCCallCount() -> u32;
...
//     fn ISteamGameServerUtils_PostPS3SysutilCallback(uc_int64_t status, uc_int64_t param, void* userdata) -> void;
...
//     fn ISteamGameServerUtils_ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eLineInputMode, const char *pchDescription, u32 unCharMax, const char *pchExistingText) -> bool;
//     fn ISteamGameServerUtils_GetEnteredGamepadTextLength() -> u32;
//     fn ISteamGameServerUtils_GetEnteredGamepadTextInput(char *pchText, u32 cchText) -> bool;
//     fn ISteamGameServerUtils_GetSteamUILanguage() -> const char *;
//     fn ISteamGameServerUtils_IsSteamRunningInVR() -> bool;
//     fn ISteamGameServerUtils_SetOverlayNotificationInset(c_int nHorizontalInset, c_int nVerticalInset) -> void;
// }
